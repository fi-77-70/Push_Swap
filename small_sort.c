...
/*   Updated: 2024/08/08 17:22:52 by filferna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_3(node **stack_a, node **stack_b)
{
	...
	temp = *stack_a;
	if (temp->number > temp->next->number && temp->number > temp->next->next->number)
		ft_rotate('a', stack_a, stack_b);
	else if (temp->next->number > temp->number && temp->next->number > temp->next->next->number)
